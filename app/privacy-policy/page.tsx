...
export default function PrivacyPolicy() {
    return (
        <main className="w-full max-w-5xl min-h-screen px-6 py-10">
            <div className="flex flex-col space-y-6">
                <h1 className="text-4xl font-bold">Privacy Policy</h1>
                <p className="text-sm text-gray-500">Last updated: May 21, 2024</p>
                <p className="text-lg">This Privacy Policy describes Our policies and procedures on the collection, use
                    and disclosure
                    of Your information when You use the Service and tells You about Your privacy rights and how the
                    law protects You.</p>
                <p className="text-lg">We use Your Personal data to provide and improve the Service. By using the
                ...
                <p className="text-lg">The words of which the initial letter is capitalized have meanings defined under
                    the following
                ...
                <ul className="list-disc list-inside space-y-2 text-lg">
                    ...
                    <li>
                        ...
                        Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in
                        this Agreement) refers to Caffeina Politica.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Website</strong> refers to Caffeina Politica, accessible
                        from <Link
                        href="https://www.caffeinapolitica.com/" rel="external nofollow noopener"
                        target="_blank" className="underline">https://www.caffeinapolitica.com</Link>
                ...
                <p className="text-lg">While using Our Service, We may ask You to provide Us with certain personally
                    identifiable
                ...
                <p className="text-lg">Usage Data may include information such as Your Device&apos;s Internet Protocol
                    ...
                    diagnostic data.</p>
                <p className="text-lg">When You access the Service by or through a mobile device, We may collect certain
                    information
                ...
                <p className="text-lg">We may also collect information that Your browser sends whenever You visit our
                    Service or when
                ...
                <p className="text-lg">We use Cookies and similar tracking technologies to track the activity on Our
                    Service and store
                ...
                <p className="text-lg">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent
                    Cookies remain on Your
                    personal
                    computer or mobile device when You go offline, while Session Cookies are deleted as soon as You
                    close Your web browser. Learn more about cookies on the <Link
                        href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking"
                        target="_blank" className="underline">Free Privacy Policy website</Link> article.</p>
                ...
                <p className="text-lg">For more information about the cookies we use and your choices regarding cookies,
                    please visit
                ...
                <p className="text-lg">The Company will retain Your Personal Data only for as long as is necessary for
                    the purposes set
                ...
                <p className="text-lg">The Company will also retain Usage Data for internal analysis purposes. Usage
                    Data is generally
                ...
                <p className="text-lg">Your information, including Personal Data, is processed at the Company&apos;s
                ...
                <p className="text-lg">Your consent to this Privacy Policy followed by Your submission of such
                    information represents
                    Your agreement to that transfer.</p>
                <p className="text-lg">The Company will take all steps reasonably necessary to ensure that Your data is
                    treated securely
                ...
                <p className="text-lg">If the Company is involved in a merger, acquisition or asset sale, Your Personal
                    Data may be
                    transferred. We will provide notice before Your Personal Data is transferred and becomes subject
                    to a different Privacy Policy.</p>
                <h3 className="text-xl font-semibold">Law enforcement</h3>
                <p className="text-lg">Under certain circumstances, the Company may be required to disclose Your
                    Personal Data if
                ...
                <p className="text-lg">The Company may disclose Your Personal Data in the good faith belief that such
                    action is
                    necessary to:</p>
                <ul className="list-disc list-inside space-y-2 text-lg">
                    <li>
                ...
                <p className="text-lg mb-6">The security of Your Personal Data is important to Us, but remember that no
                ...
                <p className="mb-4">Our Service does not address anyone under the age of 13. We do not knowingly collect
                ...
                <p className="mb-4">If We need to rely on consent as a legal basis for processing Your information and
                ...
                <p className="mb-4">Our Service may contain links to other websites that are not operated by Us. If You
                ...
                <p className="mb-4">We have no control over and assume no responsibility for the content, privacy
                ...
                <p className="mb-4">We will let You know via email and/or a prominent notice on Our Service, prior to
                    the change becoming effective and update the &quot;Last updated&quot; date at the top of this
                    Privacy Policy.</p>
                <p className="mb-4">You are advised to review this Privacy Policy periodically for any changes. Changes
                ...
                <ul className="list-disc pl-6">
                    <li>By email: <Link href="mailto:caffeinapolitica@gmail.com"
                                        className="underline">caffeinapolitica@gmail.com</Link></li>
                </ul>
            </div>
        </main>
    )
